...
#    print(v)
  ...
  #  print(limit)
   ...
   #     print(success)
    ...
    #    print(output)
        idfsComplexity += len(discoveredList)
        foundCount += 1
        return 1
...
def menu():
    ...
    if option == '1':
      #  graphList = []
        ...
        for x in range(100):  #will be 100, but not spending the time on that now
            makeGraph()
    ...
    if option == '4':
        ...
        print(output)
        output = "average space complexity (list of visited nodes) was " + str(averageNodesVisited /len(graphList))
        print(output)
        menu()
    ...
    if option == '8':
        ...
        print(output)
        output = "average space complexity (list of visited nodes) was " + str(idfsComplexity / len(graphList))
        print(output)
        menu()
    ...
    if option == '13':
        ...
        print(output)
        averageNodesVisited
        output = "total time to run BFS on all graphs: " + str(totalTime*1000) + "ms"
        print(output)
        output = "average nodes visited (time complexity) was " + str(nodesTraversed / len(graphList))
        print(output)
        output = "average space complexity (list of visited nodes) was " + str(averageNodesVisited / len(graphList))
        ...
        output = "found the goal " + str(foundCount) + "of " + str(len(graphList)) + "times"
        print(output)
        output = "Total time to run DFS on all graphs: " + str(totalTime*1000) + "ms"
        print(output)
        output = "average nodes visited (time complexity) was " + str(nodesTraversed / len(graphList))
        print(output)
        output = "average space complexity (list of visited nodes) was " + str(averageNodesVisited /len(graphList))
        ...
        print(output)
        nodesTraversed /= len(graphList)
        output = "total time to run IDFS on all graphs: " + str(totalTime*1000) + "ms"
        print(output)
        output = "average nodes visited (time complexity) was " + str(nodesTraversed)
        print(output)
        output = "average space complexity (list of visited nodes) was " + str(idfsComplexity / len(graphList))
        ...
        print(output)
        nodesTraversed /= len(graphList)
        output = "total time to run greedy on all graphs: " + str(totalTime*1000) + "ms"
        print(output)
        output = "average nodes visited (time complexity) was " + str(nodesTraversed)
        print(output)
        output = "average space complexity (list of visited nodes) was " + str(averageNodesVisited / len(graphList))
        ...
        print(output)
        nodesTraversed /= len(graphList)
        output = "total time to run A* on all graphs: " + str(totalTime*1000) + "ms"
        print(output)
        output = "average nodes visited (time complexity) was " + str(nodesTraversed)
        print(output)
        output = "average space complexity (list of visited nodes) was " + str(averageNodesVisited / len(graphList))
